  ...
  >
    ...
    <q-card class=" full-height" style="width: 300px">
      ...
      <div class="row items-center">
         <q-img class="col-4 offset-1" :src="pizza.image" alt=""/>
        <div class="col-4 offset-1">
          <p class="text-caption no-margin">Каллорий: {{pizza.belki}} </p>
          <p class="text-caption  no-margin">Белки: {{pizza.belki}}</p>
          <p class="text-caption  no-margin" >Жиры: {{pizza.fat}} </p>
          <p class="text-caption  no-margin">Углеводы: {{pizza.uglevod}}</p>
        </div>
      </div>
...
<!--        <q-separator class="q-my-sm"/>-->
  ...
  class="q-mr-sm"
    ...
    />
        ...
        <q-separator class="q-my-sm"/>
        <p class="no-margin">Добавить ингредиенты</p>
<flicking
  ...
  <q-card
   ...
   <div class="q-pa-sm full-width" >
          <p class="h4 text-bold no-margin">Сумма: {{total_price}} р</p>
       <q-btn
         color="primary"
         :loading="is_loading"
         @click="addToCart"
